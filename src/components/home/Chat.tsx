...
const KNOWLEDGE_BASE: Record<string, string> = {
  ...
  '怎么联系你？': '可以通过本页面留下的联系方式找到我，或者在这里给我留言。',
  '你是谁？': '你好，我是林安的数字分身。我受过林安个人经历和职业背景的专门训练。',
  '你擅长什么？': '我擅长内容策划、AI 应用以及知识整理，喜欢把复杂的问题讲成人话。'
};

const DEFAULT_ANSWER = '这个问题我暂时还不太清楚，欢迎直接联系林安探讨。';
